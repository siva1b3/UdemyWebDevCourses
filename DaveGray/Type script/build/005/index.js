...
let a1 = "hello"; // Variable a1 is assigned a value of type 'one', which is a string.
let b1 = a1; // Type assertion: a1 is asserted as type 'two', which is a union of string or number.
let c2 = a1; // Type assertion: a1 is asserted as type 'three', which is a literal type "hello".
let d1 = "world"; // Type assertion using angle bracket syntax.
let e1 = "world"; // Type assertion of a string literal.
let e2 = 23; // Type assertion of a number literal.
let e3 = 23; // Type assertion of a union type of number or string.
// ! Assertion example
function concatOrAdd(a = 0, b = 0, c) {
    if (c === "add")
        return a + b; // If 'c' is 'add', returns the sum of 'a' and 'b'.
...
let myString = concatOrAdd(1, 2, "concat");
...
let myVal = concatOrAdd(1, 2, "concat");
